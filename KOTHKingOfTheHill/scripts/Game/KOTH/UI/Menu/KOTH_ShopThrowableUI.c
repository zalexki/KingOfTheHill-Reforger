class KOTH_ShopThrowableUI : KOTH_ShopGunClass
{
	...
	//===============================================================================================================
	/*override protected void AddItemsFromConfig()
	{
		...
		{
			onForeach("{20EF71DE68A5887E}UI/Layouts/HUD/Shop/ShopGun_ItemList.layout", item)
		}
	}*/
	//===============================================================================================================
